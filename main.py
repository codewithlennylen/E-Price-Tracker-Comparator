...
urlLink = 'https://www.amazon.com/s?k=gtx+1650&ref=nb_sb_noss'
...
# cards = soup.select("#a-section a-spacing-none")[0].get_text().strip() # first element of array, strip whitespaces.

# contentCards = soup.findAll('div',{'class':'a-section a-spacing-none'})
# contentCards = soup.find_all('h2')
